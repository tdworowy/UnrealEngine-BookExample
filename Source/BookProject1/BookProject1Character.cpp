...
void ABookProject1Character::SetupPlayerInputComponent(
  ...
  PlayerInputComponent->BindAxis("MoveForward", this,
                                 &ABookProject1Character::MoveForward);
  PlayerInputComponent->BindAxis("MoveRight", this,
                                 &ABookProject1Character::MoveRight);
  ...
  PlayerInputComponent->BindAxis("TurnRate", this,
                                 &ABookProject1Character::TurnAtRate);
  PlayerInputComponent->BindAxis("LookUp", this,
                                 &APawn::AddControllerPitchInput);
  PlayerInputComponent->BindAxis("LookUpRate", this,
                                 &ABookProject1Character::LookUpAtRate);

  // handle touch devices
  PlayerInputComponent->BindTouch(IE_Pressed, this,
                                  &ABookProject1Character::TouchStarted);
  PlayerInputComponent->BindTouch(IE_Released, this,
                                  &ABookProject1Character::TouchStopped);

  // VR headset functionality
  PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this,
                                   &ABookProject1Character::OnResetVR);
}

void ABookProject1Character::OnResetVR() {
  // If BookProject1 is added to a project via 'Add Feature' in the Unreal
  // Editor the dependency on HeadMountedDisplay in BookProject1.Build.cs is not
...
void ABookProject1Character::TouchStarted(ETouchIndex::Type FingerIndex,
                                          FVector Location) {
  Jump();
}

void ABookProject1Character::TouchStopped(ETouchIndex::Type FingerIndex,
                                          FVector Location) {
  StopJumping();
}
