...
ABaseCharacter::ABaseCharacter() {
  ...
  SwordCollisionBox =
      CreateDefaultSubobject<UBoxComponent>(TEXT("SwordCollisionBox"));
  ...
  SwordCollisionBox->SetCollisionObjectType(
      ECollisionChannel::ECC_WorldDynamic);
  SwordCollisionBox->SetCollisionResponseToAllChannels(
      ECollisionResponse::ECR_Ignore);
  SwordCollisionBox->SetCollisionResponseToChannel(
...
void ABaseCharacter::SwordBoxBeginOverlap(
...
void ABaseCharacter::SetIsAttacking(bool Attacking) { bAttacking = Attacking; }