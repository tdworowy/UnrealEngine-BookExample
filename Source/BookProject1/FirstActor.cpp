...
AFirstActor::AFirstActor() {
  ...
  FirstActorMesh =
      CreateDefaultSubobject<UStaticMeshComponent>(TEXT("FirstActorMeshComp"));
...
void AFirstActor::Tick(float DeltaTime) {
  ...
  /*UE_LOG(LogTemp, Warning, TEXT("%s Location: (%f %f %f), Rotation: (%f %f
     %f)"), *GetName(), Location.X, Location.Y, Location.Z, Rotation.Pitch,
     Rotation.Yaw, Rotation.Roll); */
...
void AFirstActor::CheckLifetime() { ActorLevel = ActorLifetime; }
