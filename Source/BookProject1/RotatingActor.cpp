...
#include <BookProject1/MainCharacter.h>
...
void ARotatingActor::BeginPlay() {
  ...
  if (MainCharacter) {
    MainCharacter->RotateDelegate.BindUObject(this,
                                              &ARotatingActor::ToggleRotate);
    MainCharacter->DynamicRotateDelegate.BindDynamic(
        this, &ARotatingActor::SetRotationRate);
  }
}
