...
AFloorSwitch::AFloorSwitch() {
  ...
  FloorSwitch =
      CreateDefaultSubobject<UStaticMeshComponent>(TEXT("FloorSwitch"));
...
void AFloorSwitch::BeginPlay() {
  ...
  TriggerBox->OnComponentBeginOverlap.AddDynamic(this,
                                                 &AFloorSwitch::OnOverlapBegin);
  TriggerBox->OnComponentEndOverlap.AddDynamic(this,
                                               &AFloorSwitch::OnOverlapEnd);
...
// Called every frame
void AFloorSwitch::Tick(float DeltaTime) { Super::Tick(DeltaTime); }
...
void AFloorSwitch::UpdateFloorSwitchLocation(float DoorLocation,
